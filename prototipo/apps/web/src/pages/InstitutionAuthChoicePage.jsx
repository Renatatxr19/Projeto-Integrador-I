...
const InstitutionAuthChoicePage = () => {
  const navigate = useNavigate();

  return (
    <>
      <Helmet>
        <title>Acesso da Instituição - Rede Solidária</title>
      </Helmet>
        ...
        <div className="w-full max-w-md space-y-8 text-center bg-white p-8 rounded-3xl border border-purple-100 shadow-sm relative">
          ...
          <div className="flex flex-col items-center space-y-3 pt-4">
            ...
            <div className="space-y-1">
              <h2 className="text-2xl font-extrabold text-[#5E3A75]">Área da ONG</h2>
              <p className="text-muted-foreground text-xs font-semibold px-4">
                Sua instituição já é parceira cadastrada na Rede Solidária?
              </p>
            </div>
          </div>
...
export default InstitutionAuthChoicePage;
